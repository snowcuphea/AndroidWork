...
/*
    ...
    OnCameraMoveListener => 지도의 위치가 바뀌거나 줌레벨이 변경되어 카메라가
    이동되기 시작할 때 이벤트에 대한 처리
...
public class MapEventTest extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(map!=null){
            ...
            //현재 나의위치를 포인트로 표시 - 위치기반서비스에 대한 퍼미션 체크가 완료되어야 표시됨
    ...
    public void onCameraMove() {
        Toast.makeText(this,"카메라가 이동됩니다.",
    ...
    public void onCameraMoveStarted(int i) {
        Toast.makeText(this,"카메라가 이동 시작!",
                Toast.LENGTH_SHORT).show();
    }
}
