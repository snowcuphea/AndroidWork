...
public class MainActivity extends AppCompatActivity {
    ...
    /*
        ...
        긴 시간 동안 실행하며 view를 변경하려고 하는 경우 실행되는 동안 다른 작업을 할 수 없다.
        실행되는 동안 사용자의 이벤트가 발생하고, 이벤트에 5초동안 반응하지 않으면
        안드로이드 OS는 어플리케이션을 강제 종료한다.
        ANR(Application Not Responding)
        오랫동안 처리해야 하는 작업을 UI 쓰레드에 정의하면 안된다.
                             -------------------------------
                               ㄴ> 별도의 작업 쓰레드를 정의하고 실행
    ...
    */
    ...
    public void useThread(View view){
        ...
        //프로그래스바의 progess가 변경되는 것을 쓰레드로 만들어서 실행
